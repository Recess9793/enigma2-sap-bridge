...
class IGMPMonitor:
    ...
    def _bridge_group(group):
        # LAN uses 239.192.7.0/24; the additional WLAN profile uses
        # 239.192.8.0/24. The Manager still ignores groups for which it
        # has no configured channel.
        return group.startswith("239.192.")
    ...
    def _packet(self, packet):
        ...
        # IGMPv3 is represented by its own Scapy class. Windows VLC
        # normally emits these reports to 224.0.0.22.
        ...
        # IGMPv1/v2. macOS VLC commonly emits v2 reports directly to
        # the requested multicast group and v2 leaves to 224.0.0.2.
